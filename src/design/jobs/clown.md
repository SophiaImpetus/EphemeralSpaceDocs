...
- Pie Launcher, launches pies.

# Balatromancy {.es-unimplemented}
...
- Can of Worms, a fake container that matches a random existing container (such as medical pouches, packs of cigarettes, etc). When opened it unleashes, at random, rubber burstworms which deal impact damage, or animatronic leeches which bite and damage anyone nearby, or a dizzying cloud of spores.
- Gag Food, a spiked food item that appears like any other food but is either Rotten, Spicy or Frozen. Rotten food causes hunger loss and creates miasma when eaten. Spicy food sets the eater on fire and creates fire on random nearby tiles. Frozen food applies a debuff giving the eater cryohusk speech patterns and releases cryogas when eaten.


Each of the three choices has a 5% chance to be a rare item from the following list:
